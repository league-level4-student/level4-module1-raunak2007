...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Instructions: You will have to move your arrow keys so that the snake gets its food";
	...
	private void setFoodLocation() {
		...
		Location foodLoc=new Location(50*new Random().nextInt(14),50*new Random().nextInt(11));
	...
	private void gameOver() {
		...
		String choice=JOptionPane.showInputDialog("Do you want to play again?");
